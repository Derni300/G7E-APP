...
<div class="container-big">
    ...
    <div class="capteur-line">
        <div class="capteur-left">
            <img src="images/co2-cloud.png" alt="Feature 01" style="width: 20em;">
            <h4 style="font-size: 3em;">Capteur CO2</h4>
            <p>
                Le capteur CO2 envoit les données collectées dans notre base de données. 
                Cela nous permet d'estimer le niveau de pollution des environs
            </p>
        </div>

        <div class="capteur-right">
            <img src="images/hot.png" alt="Feature 02" style="width: 20em;">
            <h4 style="font-size: 3em;">Température</h4>
    ...
    <div class="capteur-line">
        <div class="capteur-left">
            <img src="images/map.png" alt="Feature 03" style="width: 20em;">
            <h4 style="font-size: 3em;">Géolocalisation</h4>
            <p>
        ...
        <div class="capteur-right">
            <img src="images/planet-earth.png" alt="Feature 04" style="width: 20em;">
            <h4 style="font-size: 3em;">Respectueuse de l'environnement</h4>
            <p style="font-size: 1.1em;">
